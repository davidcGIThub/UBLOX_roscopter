...
"""autogenerated by genpy from ublox/ObsVec.msg. Do not edit."""
import sys
...
class ObsVec(genpy.Message):
  _md5sum = "8a4f9806d43a231fbb3bd9433d21b316"
  _type = "ublox/ObsVec"
...
"""
  ...
  _slot_types = ['std_msgs/Header','time','ublox/Observation[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObsVec, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.obs:
        ...
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = val1
        buff.write(_get_struct_2BdI7d3B().pack(_x.sat, _x.gnssID, _x.freq, _x.locktime, _x.cno, _x.L, _x.P, _x.D, _x.stdevL, _x.stdevP, _x.stdevD, _x.LLI, _x.code, _x.signal))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.sat, _x.gnssID, _x.freq, _x.locktime, _x.cno, _x.L, _x.P, _x.D, _x.stdevL, _x.stdevP, _x.stdevD, _x.LLI, _x.code, _x.signal,) = _get_struct_2BdI7d3B().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_2BdI7d3B = None
def _get_struct_2BdI7d3B():
    global _struct_2BdI7d3B
    if _struct_2BdI7d3B is None:
        _struct_2BdI7d3B = struct.Struct("<2BdI7d3B")
    return _struct_2BdI7d3B
_struct_2I = None
def _get_struct_2I():
    global _struct_2I
